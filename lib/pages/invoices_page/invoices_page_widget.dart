...
import 'invoices_page_model.dart';
export 'invoices_page_model.dart';

class InvoicesPageWidget extends StatefulWidget {
  const InvoicesPageWidget({
    super.key,
    this.pdfdata,
  });

  final FFUploadedFile? pdfdata;

  @override
  State<InvoicesPageWidget> createState() => _InvoicesPageWidgetState();
}

class _InvoicesPageWidgetState extends State<InvoicesPageWidget>
    with TickerProviderStateMixin {
  late InvoicesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InvoicesPageModel());
