...
import 'weekly_time_sheet_model.dart';
export 'weekly_time_sheet_model.dart';

class WeeklyTimeSheetWidget extends StatefulWidget {
  const WeeklyTimeSheetWidget({super.key});

  @override
  State<WeeklyTimeSheetWidget> createState() => _WeeklyTimeSheetWidgetState();
}

class _WeeklyTimeSheetWidgetState extends State<WeeklyTimeSheetWidget> {
  late WeeklyTimeSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeeklyTimeSheetModel());
